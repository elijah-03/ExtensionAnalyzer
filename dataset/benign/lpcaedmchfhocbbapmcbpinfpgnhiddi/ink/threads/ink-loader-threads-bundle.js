...
var ASM_CONSTS = {
  318768: ($0, $1, $2, $3) => setTimeout(() => window.inkWasmRegistry[$3].dynCalls["vi"]($1, $2), $0),
  318853: $0 => {
    clearTimeout($0);
  },
  318875: ($0, $1) => {
  ...
  319305: $0 => window.inkHostRegistry[$0].shouldPreloadShaders(),
  319367: $0 => window.inkHostRegistry[$0].shouldRegisterDocument(),
  319431: ($0, $1, $2, $3, $4, $5) => {
